...
let homeScreen_1 = {
  key: "startPage",
  greeting: "Willkommen bei Software AG",
  label_1: "Was sind ihre Produkte",
  label_2: "Was macht Software AG",
  label_3: "Wo befindet sich Sowftware AG",
};

let homeScreen_2 = {
  key: "IoT",
  greeting: "Erreichen Sie mehr mit IoT und sehen Sie die Ergebnisse schneller",
  label_1: "Was ist IoT",
  label_2: "Vorteile für Ihr Unternehmen",
  label_3: "IoT in Ihrer Branche",
};

const homeScreens = [homeScreen_1, homeScreen_2];

let homeScreenKey = homeScreen_1.key;
  ...
  return (
    <div className="App">
      <button
        style={{ margin: "10em" }}
        onClick={() => {
          homeScreenKey = homeScreen_2.key;
          instance.destroySession();
          document
            .getElementsByClassName("WatsonAssistantChatHost")[0]
            .remove();
          setChatbot((wacInstance) => {
            handleRouting(wacInstance, homeScreenKey);
          }, setInstance);
        }}
      >
        IoT
...
function handleRouting(instance, homeScreenKey) {
  const homeScreen = homeScreens.find((h) => h.key === homeScreenKey);
  instance.updateHomeScreenConfig({
    ...
    starters: {
      ...
      buttons: [
        {
          label: homeScreen.label_1,
        },
        {
          label: homeScreen.label_2,
        },
        {
          label: homeScreen.label_3,
        },
      ],
    },
  });
